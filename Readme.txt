...
The ultimate objective of this project is to use the digital pot to mute and change the volume of a speaker attached to an 
Epson projector. This is basically the proof of concept of the functionality. Very impressed with the simplicity and power of the 
serial SPI bus. 
